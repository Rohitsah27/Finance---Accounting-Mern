...
### 4.1a Extended Lifecycle Matrix: DBA with Premium Payment Variance (Extra Pay / Pay Short)

Stage 2 in the live `pas-policy.html` Event Data Injector has three mutually-exclusive variants — **Match** (the `PAYMENT_RECEIVED` path documented in 4.1 above), **Extra Pay** (`PAYMENT_OVERPAID`), and **Pay Short** (`PAYMENT_UNDERPAID`) — each its own event type so injecting one doesn't lock out the others. Extra Pay never reaches the MGA: the overage is booked straight to a credit balance owed back to the insured, so Stage 3/5 downstream are untouched. Pay Short does the opposite — it rides down the *entire* chain, since nobody downstream can forward cash they were never actually given.

| Lifecycle Stage | Trigger Action | Broker (HIT) JE | MGA (NTA) JE | Carrier (SOUTHLAKE) JE | Chain Status & Net Cash Movement |
| :--- | :--- | :---: | :---: | :---: | :--- |
| **Stage 2 (Extra Pay): Insured Overpayment** | Ayushi pays Broker $40,500 (vs. $39,260 billed) in `pas-policy.html` — `PAYMENT_OVERPAID` | ✅ **`JE-2026-0002` (Extra Pay variant)**<br>• Dr. 1001 Cash $40,500.00<br>• Cr. 1100 AR $39,260.00<br>• Cr. 2001 Customer Credit Balance Payable $1,240.00 | ❌ *None (unaffected — still owed the full $36,760 net premium)* | ❌ *None (Pending Bordereau)* | **+$40,500.00** into HIT Trust Account. The $1,240.00 overage is parked as a refund owed to Ayushi, not routed toward NTA — Stage 3 still settles at the full $36,760.00. |
| **Stage 2 (Pay Short): Insured Underpayment** | Ayushi pays Broker $35,000 (vs. $39,260 billed) in `pas-policy.html` — `PAYMENT_UNDERPAID` | ✅ **`JE-2026-0002` (Pay Short variant)**<br>• Dr. 1001 Cash $35,000.00<br>• Cr. 1100 AR (Partial Clear) $35,000.00 *($4,260.00 remains outstanding)* | ❌ *None (Pending Broker Remittance)* | ❌ *None (Pending MGA Settlement & Bordereau)* | **+$35,000.00** into HIT Trust Account; $4,260.00 stays open on Ayushi's receivable. HIT's $36,760.00 obligation to NTA from Stage 1 is unchanged — but HIT doesn't actually hold enough cash to forward it in full. |
| **Stage 3 (adjusted): Broker Settlement After Shortfall** | `pas-policy.html` auto pre-fills Broker Settlement at $32,500.00 (reduced from $36,760.00) once Stage 2 Pay Short is posted | ✅ **`JE-2026-0003` (Pay Short variant)**<br>• Dr. 2200 AP (Partial Clear) $32,500.00 *($4,260.00 remains outstanding)*<br>• Cr. 1001 Cash $32,500.00 | ✅ **`JE-2026-0002` (Pay Short variant)**<br>• Dr. 1001 Cash $32,500.00<br>• Cr. 1100 AR (Partial Clear) $32,500.00 *($4,260.00 remains outstanding)* | ❌ *None (Pending MGA Remittance & Bordereau)* | **-$32,500.00** from HIT Trust → NTA Trust. Both books carry the identical $4,260.00 residual — the Stage 2 shortfall, not absorbed or invented away. |
| **Stage 4 (unaffected): Bordereau Ingestion** | Carrier ingests Bordereau — independent of any Stage 2 shortfall; this is the Carrier's fixed GWP recognition and AP-bill obligation | ❌ *None (already booked in Stage 1)* | ❌ *None (AP already booked in Stage 1)* | ✅ **`JE-2026-0001` (Bordereau Ingestion)**<br>• Dr. 1100 AR (NTA) $29,757.00<br>• Dr. 5100 Acquisition Costs & Broker Commissions — NTA Program Distribution Commission $6,000.00<br>• Cr. 4001 GWP $35,757.00 | Carrier books the full $29,757.00 receivable regardless of what happened upstream. GWP is gross of the *full* $6,000 distribution load (MGA override + HIT's retail commission, paid through NTA), not just the MGA's own cut — netting the Broker's commission out would understate GWP by $2,500. That $6,000 posts as ONE line to NTA, not split out by HIT's name — the Carrier's only contract is with NTA, and how NTA further allocates it downstream isn't the Carrier's book to keep. What NTA can actually *remit* against the $29,757.00 receivable is a Stage 5 cash question, not a Stage 4 recognition one. |
| **Stage 5 (adjusted): Carrier Settlement After Shortfall** | `pas-policy.html` auto pre-fills Carrier Payment at $25,497.00 (reduced from $29,757.00) — the Stage 2 shortfall carries one hop further | ❌ *None (Fully Settled)* | ✅ **`JE-2026-0003` (Pay Short variant)**<br>• Dr. 2200 AP (Partial Clear) $25,497.00 *($4,260.00 remains outstanding)*<br>• Cr. 1001 Cash $25,497.00 | ✅ **`JE-2026-0002` (Pay Short variant)**<br>• Dr. 1001 Cash $25,497.00<br>• Cr. 1100 AR (Partial Clear) $25,497.00 *($4,260.00 remains outstanding)* | **-$25,497.00** from NTA Trust → SOUTHLAKE Operating. The original $4,260.00 gap has now cascaded end-to-end — Ayushi → HIT → NTA → SOUTHLAKE all show the exact same shortfall as an open balance, never doubled and never dropped. |
