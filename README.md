...
| **Stage 4 (unaffected): Bordereau Ingestion** | Carrier ingests Bordereau — independent of any Stage 2 shortfall; this is the Carrier's fixed GWP recognition and AP-bill obligation | ❌ *None (already booked in Stage 1)* | ❌ *None (AP already booked in Stage 1)* | ✅ **`JE-2026-0001` (Bordereau Ingestion)**<br>• Dr. 1100 AR (NTA) $29,757.00<br>• Dr. 5100 Acquisition Costs — MGA Override $3,500.00<br>• Cr. 4001 GWP $33,257.00 | Carrier books the full $29,757.00 receivable regardless of what happened upstream — same as 4.1's Stage 4b. What NTA can actually *remit* against it is a Stage 5 cash question, not a Stage 4 recognition one. |
